...
var mapName = document.getElementById("mapname").getAttribute("value");
alert ("loading level "+ mapName);
    // "test";
        ...
        if(current_time - last_spawn_time > time_til_spawn) {
            ...
            if (monsterLoadArray.length != 0) {
                ...
                if (popedValue === 0) {
                    ...
                    enemyArray[enemyArrayIndex] = new eliteMonster(enemyArrayIndex, game, enemyBullets, mons_start_position_x+size/20, mons_start_position_y+size/20, home, 'tie', 5000 , 30 , 100, 1);
                }
                enemyArrayIndex++;
